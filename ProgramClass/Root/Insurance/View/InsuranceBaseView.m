...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    NSInteger count = self.insuranceProductModel.list.count;
    if (count == 0)
    {
...
{
    InsuranceProductDetailModel *model = [InsuranceProductDetailModel mj_objectWithKeyValues:self.insuranceProductModel.list[indexPath.row]];
    InsuranceViewCellTableViewCell *cell = [BaseTableViewCell cellClassName:@"InsuranceViewCellTableViewCell"
