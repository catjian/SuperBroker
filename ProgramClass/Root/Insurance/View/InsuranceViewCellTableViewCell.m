...
- (void)createCenterView
{
    ...
    m_secDetail = [[UILabel alloc] initWithFrame:CGRectMake(0, m_firDetail.bottom+5, m_firDetail.width, DIF_PX(35))];
    [m_secDetail setNumberOfLines:2];
...
//    [m_thrDetail setAttributedText:model[@"contentMoney2"]];
    ...
    [m_rightImage setText:model[@"promotionRewards"]];
}
