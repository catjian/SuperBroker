...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == [MyViewDataModel getDataModelWithBrokerInfoDataModel:self.brokerInfoModel].count-1 &&
...
//    [m_TopView addSubview:spaceView];
    ...
    NSDictionary *levelNames = @{@"6":@"高级会员", @"7":@"中级会员", @"8":@"初级会员"};
