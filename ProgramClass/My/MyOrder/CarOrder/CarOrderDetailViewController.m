...
- (UIView *)createCommonView
{
    ...
    [ownerView.contentFriLab setText:[NSString stringWithFormat:@"姓名：%@", carInsuredInfoModel.insuredName]];
    ...
    [carInfoView.contentSecLab setText:[NSString stringWithFormat:@"发动机号：%@", carInsuredInfoModel.carNumber]];
