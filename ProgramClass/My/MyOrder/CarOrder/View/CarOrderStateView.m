...
- (UIView *)createStateViewWithView:(UIView *)topView
{
    ...
    UILabel *moneyLab = [[UILabel alloc] initWithFrame:self.stateLab.frame];
    [moneyLab setFont:DIF_UIFONTOFSIZE(13)];
    [moneyLab setTextColor:DIF_HEXCOLOR(@"FF5000")];
    [moneyLab setTextAlignment:NSTextAlignmentRight];
    [moneyLab setText:@"推广奖励50-100元"];
