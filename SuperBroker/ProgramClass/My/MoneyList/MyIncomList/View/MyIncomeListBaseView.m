...
@implementation MyIncomeListBaseView
{
...
- (void)setListModel:(NSMutableArray<MyIncomeListModel *> *)listModel
{
    _listModel = listModel;
    [m_listModel removeAllObjects];
    for(MyIncomeListModel *model in listModel)
    {
        [m_listModel addObjectsFromArray:model.getIcomeListData];
    }
}
...
{
    MyIncomeListBaseViewCell *cell = [BaseTableViewCell cellClassName:@"MyIncomeListBaseViewCell"
