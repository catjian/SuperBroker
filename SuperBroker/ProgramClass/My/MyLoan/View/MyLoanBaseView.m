...
- (void)setListModel:(MyloadListModel *)listModel
{
...
{
    MyLoanViewCell *cell = [MyLoanViewCell cellClassName:@"MyLoanViewCell"
                                             InTableView:tableView
                                         forContenteMode:[MyloadListDetailModel mj_objectWithKeyValues:self.listArrModel[indexPath.row]]];
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.selectBlock)
    {
        self.selectBlock(indexPath, [MyloadListDetailModel mj_objectWithKeyValues:self.listArrModel[indexPath.row]]);
    }
}
