...
@implementation MyPerformanceCreditBaseView
{
    UIView *m_BGView;
}
...
{
    MyPerformaceCreditViewCell *cell = [MyPerformaceCreditViewCell cellClassName:@"MyPerformaceCreditViewCell"
                                                                     InTableView:tableView
                                                                 forContenteMode:[MyPerformanceCreditDetailModel mj_objectWithKeyValues:self.listArrModel[indexPath.row]]];
    return cell;
}
