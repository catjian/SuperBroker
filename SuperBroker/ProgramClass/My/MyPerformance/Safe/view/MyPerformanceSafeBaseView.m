...
@implementation MyPerformanceSafeBaseView
{
    UIView *m_BGView;
}
...
{
    MyPerformanceSafeViewCell *cell = [MyPerformanceSafeViewCell cellClassName:@"MyPerformanceSafeViewCell"
                                                           InTableView:tableView
                                                       forContenteMode:[MyPerformanceSafeDetailModel mj_objectWithKeyValues:self.listArrModel[indexPath.row]]];
    return cell;
}
